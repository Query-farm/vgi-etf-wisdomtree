...
#
# Single image serving BOTH transports of the vgi-etf-wisdomtree worker:
...
ARG SOURCE_URL=https://github.com/Query-farm/vgi-etf-wisdomtree

LABEL org.opencontainers.image.title="vgi-etf-wisdomtree" \
      org.opencontainers.image.description="WisdomTree US ETF data as a VGI worker for DuckDB/SQL (stdio + HTTP)" \
